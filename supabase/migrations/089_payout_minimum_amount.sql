-- Valor mínimo de saque: R$ 50,00. Antes só validava p_amount > 0 -- um
-- booster conseguia solicitar centavos, gerando custo operacional de
-- processar/aprovar/pagar um PIX de valor irrisório.
